...
// The Windows Credential Manager backs secrets (API keys, p8 keys) via the
// `secrets` field.
...
struct AppEnvironment {
    ...
    /// Windows Credential Manager for secrets (API keys, p8 keys). Used by
    /// account management to store and remove credentials.
...
enum Bootstrap {
    ...
    /// credential manager. Throws if the data directory or database cannot be
    /// created/opened.
